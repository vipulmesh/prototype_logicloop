    ...
    <div className="min-h-screen bg-background px-5 py-16">
      <div className="mx-auto max-w-md">
        <Card className="p-6 sm:p-8">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-primary">Candidate access</p>
          <h1 className="mt-4 text-3xl font-bold text-white">Create an account</h1>
          <p className="mt-2 text-sm text-slate-400">Register to upload your resume and view your AI-powered talent dashboard.</p>
