      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 pb-20 pt-8">
        ...
        {report && !isLoading && (
          <div className="mt-8 space-y-6">
            ...
            {report.developerProfile && resume?.profile?.githubUrl && <Card className="border border-accent/30"><div className="flex items-center justify-between gap-4"><div><h2 className="flex items-center gap-2 text-xl font-bold text-white"><Github className="text-accent" /> AI Developer Profile</h2><p className="mt-1 text-sm text-slate-400">Public GitHub signals enriched with your resume projects and verified skills.</p></div><ScoreCircle value={report.developerProfile.githubProfileStrength} label="GitHub Strength" /></div><div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3"><div className="rounded-xl border border-border bg-black/20 p-4"><p className="text-xs uppercase text-slate-500">Public Repositories</p><p className="mt-2 text-2xl font-bold text-white">{report.developerProfile.publicRepositoryCount}</p></div><div className="rounded-xl border border-border bg-black/20 p-4"><p className="text-xs uppercase text-slate-500">Top Languages</p><p className="mt-2 text-sm font-medium text-white">{report.developerProfile.topProgrammingLanguages.join(', ') || 'Not available'}</p></div><div className="rounded-xl border border-border bg-black/20 p-4"><p className="text-xs uppercase text-slate-500">Open Source Activity</p><p className="mt-2 text-sm font-medium text-white">{report.developerProfile.openSourceActivity || 'Not assessed'}</p></div><div className="rounded-xl border border-border bg-black/20 p-4"><p className="text-xs uppercase text-slate-500">Coding Maturity</p><p className="mt-2 text-lg font-bold text-primary">{report.developerProfile.estimatedCodingMaturity || 'Not assessed'}</p></div><div className="rounded-xl border border-border bg-black/20 p-4"><p className="text-xs uppercase text-slate-500">Project Quality</p><p className="mt-2 text-2xl font-bold text-emerald-400">{report.developerProfile.projectQualityScore}/100</p></div></div></Card>}
